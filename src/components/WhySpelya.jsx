  ...
  const features = [
    {
      ...
      title: "Çoklu Sektör",
      description: "Farklı sektörlerde faaliyet gösteren güçlü grup şirketleriyle geniş bir ekosistem.",
    },
    {
      icon: (
      ...
      description: "İş birlikleri ve sinerjiyle sürdürülebilir büyüme ve inovasyon.",
    },
    {
      icon: (
      ...
      description: "Geleceğe yön veren, modern ve yenilikçi yönetim anlayışı.",
    },
  ];
    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50 w-full">
      <div className="container w-full mx-auto ">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Neden Bayronix?</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Modern holding yapısı, güçlü iş birlikleri ve yenilikçi vizyonumuzla fark yaratıyoruz.
          </p>
        </div>
