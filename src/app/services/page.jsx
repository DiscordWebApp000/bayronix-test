  ...
  const services = [
    {
      ...
      description: "We develop cutting-edge AI solutions that transform businesses through intelligent automation, predictive analytics, and machine learning capabilities.",
      icon: (
      ...
      image: "/img/services/artificle-intelegent-solutions.jpg",
      benefits: [
    ...
    },
    {
      ...
      description: "We create sophisticated machine learning systems and intelligent automation solutions that revolutionize industry operations and efficiency.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      image: "/img/services/machine-development.jpg",
      benefits: [
        "Advanced Automation",
    ...
    },
    {
      ...
      description: "We deliver cutting-edge computer technology solutions including software development, system integration, and digital transformation services.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      image: "/img/services/computer-technology.jpg",
      benefits: [
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 overflow-hidden">
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-200 mb-8">
                We are pioneering the industry and building a bright future in Artificial Intelligence, Machine Development, and Computer Technologies
              </p>
      ...
      <section id="services" className="py-20 bg-transparent relative">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Our AI & Technology Services</h2>
      ...
      <section className="relative py-20 bg-blue-600 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Let's Build the Future with AI & Technology
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Discover your AI and technology solutions with Natron
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
