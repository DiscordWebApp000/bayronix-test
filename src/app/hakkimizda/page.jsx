...
export default function AboutUsPage() {
  const milestones = [
    ...
    },
    {
      ...
      description: "Establishment of our first group companies and expansion into different sectors. Significant investments in e-commerce and technology.",
      achievement: "3 Group Companies",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Investment in artificial intelligence and blockchain technologies. Establishment of our R&D center and start of innovation-focused projects.",
      achievement: "4 Sectors of Activity",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      year: "2025",
      title: "Global Vision",
      description: "Expansion into international markets and next-generation technology solutions. Rising to leadership position in different sectors with 5 group companies.",
      achievement: "5 Group Companies",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-200 mb-8">
                With 3 years of experience, we create pioneering solutions in different sectors
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Natron Holding is a powerful holding company established in 2022 and operating in different sectors. 
                With our 5 group companies specialized in technology, e-commerce, organization and consulting, 
                we offer comprehensive solutions to our customers.
              </p>
            ...
            >
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl border border-blue-200/50">
                ...
                <div className="text-sm text-gray-500 mt-1">4 years of experience</div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-2xl border border-gray-200/50">
                ...
                <div className="text-gray-700 font-medium">Group Companies</div>
                <div className="text-sm text-gray-500 mt-1">Different sectors</div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-2xl border border-gray-200/50">
                ...
                <div className="text-gray-700 font-medium">Main Sectors</div>
                <div className="text-sm text-gray-500 mt-1">Areas of expertise</div>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our technology and innovation-focused growth story from 2022 to today
            </p>
          </motion.div>
      ...
      <section className="relative py-20 bg-blue-600 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Take your business to the next level with Natron Holding
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
